...
public class CIFSOperations {
  ...
  @MediaType(value = ANY, strict = false)
	public boolean saveFileFromStream(@Config CIFSConfiguration configuration, String payload, String fileName) {
	...
	*/
  @MediaType(value = ANY, strict = false)
	public Map<String, InputStream> readFiles(@Config CIFSConfiguration configuration, @Content(primary = true) String payload, String fileNamePattern) {
	...
	*/
  @MediaType(value = ANY, strict = false)
	public List<String> readFileNames(@Config CIFSConfiguration configuration, @Content(primary = true) String payload, String fileNamePattern) {
